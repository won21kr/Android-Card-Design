 ...
 * flexible enough for use with other desired esthetics.
 */
public class BezelImageView extends com.android.imagefetcher.views.RecyclingImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!mCacheValid || width != mCachedWidth || height != mCachedHeight) {
            ...
            if (width == mCachedWidth && height == mCachedHeight) {
                ...
                // no-inspection AndroidLintDrawAllocation
